                ...
                <div class="col-md-4 col-md-offset-4">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body" style="text-align: center;">
                            <form action="javascript:checkUserAuth();">
                                <div class="form-group">
                                    <input type="text" id="username" class="form-control" name="usernameField" placeholder="Username" required>
                                </div>
                                <div class="form-group">
                                    <input type="password" id="password" class="form-control" name="passwordField" placeholder="Password" required>
                                </div>
