                ...
                <div class="col-md-8 col-md-offset-2">
                    <div class="panel panel-default" style="text-align: center;">
                        <div class="panel-body">
                            <h1>About</h1>
				            <h3>League of Mastery was created as an entry into the Riot Games API challenge, and was a joint effort between Azoy and Compadr3. Special thanks to I Sky I, XssXTricky, and DdogDylan for their "help" with beta testing.</h3>
				            <h3>League of Mastery isn't endorsed by Riot Games and doesn't reflect the views or opinions of Riot Games or anyone officially involved in producing or managing League of Legends. League of Legends and Riot Games are trademarks or registered trademarks of Riot Games, Inc. League of Legends © Riot Games, Inc.</h3>
			             </div>
                    </div>
                </div>
            </div>
